...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T data) sucsess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T data)? sucsess,
...
class __$$SucsessImplCopyWithImpl<T, $Res>
    extends _$LoginStateCopyWithImpl<T, $Res, _$SucsessImpl<T>>
...
class _$SucsessImpl<T> implements Sucsess<T> {
  ...
  @override
  String toString() {
    return 'LoginState<$T>.sucsess(data: $data)';
  }
...
abstract class Sucsess<T> implements LoginState<T> {
  const factory Sucsess(final T data) = _$SucsessImpl<T>;
